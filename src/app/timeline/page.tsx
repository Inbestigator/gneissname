    ...
    return (
        <>
            ...
            <section className="grid w-full gap-4 sm:grid-cols-2 md:grid-cols-3" style={{margin: "30px 0 30px 0"}}>
                ...
                <div
                    className="order-1 sm:order-2 md:col-span-2 sm:col-span-1 rounded-lg bg-base-200 p-4"
                    style={{
                        display: "flex",
                        alignItems: "center",
                ...
                >
                    <p style={{justifyContent: "center"}}>
                        ...
                        tangible to conceive of the distance between events.
                        <br/>
                        <br/>
            ...
            <section
                className="grid w-full gap-4 sm:grid-cols-2 md:grid-cols-3 md:grid-rows-1 sm:grid-rows-2"
            ...
            >
                ...
                <div
                    className="order-1 sm:order-2 md:col-span-2 rounded-lg bg-base-200 p-4"
                    style={{
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                ...
                >
                    <p>
                        ...
                        Minecraft to talk about geology and starting my youtube channel. <br/>
                        <br/>
            ...
            <section className="hero max-w-4xl text-balance text-center" style={{margin: "auto"}}>
                <div className="hero-content flex-col">
                    <p style={{fontSize: "1.15rem"}}>
                        ...
                        To make this a reality I am actively looking for contributors skilled in
                        <br/>
                        resource packs, datapacks, map making, Blockbench, modeling and pixel art.
                        <br/>A fondness for geology is a plus.
                        <br/>
                        <br/>
                    </p>
                    ...
                    <p style={{margin: "0px 0px -1% 0px"}}>
                        ...
                        discord if
                        you have questions or want to talk about anything.
                    </p>
                    <div className="breadcrumbs rounded-lg bg-base-200 p-4">
                        <ul>
                            <li>
            ...
            <div
                className="font-extrabold text-4xl tracking-tighter sm:text-5xl"
                ...
                <section className="grid w-full gap-4 sm:grid-cols-2 md:grid-cols-3 my-4">
                    ...
                    <div className="relative h-64 sm:h-full min-h-0 w-full">
                        <img
                            ...
                            alt={
                                "Inside the circular lobby of a museum, showing a model of the earth hung from the cieling and multiple levels of exhibit halls, with a GuideName NPC."
                            }
                            className="absolute inset-0 h-full object-cover mx-auto"
                            style={{borderRadius: "5px", filter: "drop-shadow(5px 5px 10px rgba(0,0,0,0.5))"}}
                        />
            ...
            <div style={{margin: "0px 0px 5% 0px"}}>
                ...
                <section className="grid w-full gap-4 sm:grid-cols-2 md:grid-cols-3">
                    ...
                    >
                        ...
                        assets from other times for us to use.
                        <br/>
                        <br/>
