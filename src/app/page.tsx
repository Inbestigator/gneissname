    ...
    <>
      <section className="mb-8 flex flex-col gap-6">
        ...
        <Link href="https://shop.gneiss.name" className="btn btn-dash group relative mx-auto w-fit">
          ...
          <div className="-top-4 -right-4 absolute size-8 rounded-full bg-[radial-gradient(white_30%,transparent_100%)] group-hover:hidden" />
          <div className="-top-2 -right-2 absolute size-4 animate-ping rounded-full bg-red-100 p-1 group-hover:hidden">
