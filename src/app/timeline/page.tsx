    ...
    <div className="mt-6 mb-8 flex flex-col items-center justify-center gap-4 md:my-10">
      ...
      <section className="hero">
        <div className="hero-content flex-col lg:flex-row">
          <Image
            ...
            height={384}
          />
          <p className="max-w-4xl rounded-lg bg-base-200 p-4">
            To help really understand it, I&rsquo;m creating a vanilla Java Minecraft world where traveling 1 block
            equals 1 million years. Seeing relationships at a 1 to 1 scale gives something more tangible to conceive of
            the distance between events.
            <br />
            <br />
            Alongside this scaled geologic timeline is a diorama that represents earth at that time. The timeline
            includes major events in earth's history, custom models and textures for plants and animals, and animated
            displays all based on real paleontological information.
          </p>
        </div>
      </section>
      <section className="hero">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          />
          <p className="max-w-4xl rounded-lg bg-base-200 p-4">
            So why do this in vanilla, and not with mods? Because I want anyone to be able to just own Minecraft,
            download the world, and use it without knowledge of mods.
            <br />
            <br />
            Minecraft is very approachable and it's one of the reasons why it's a good platform for education. My target
            audience is anyone that is interested in earth's history but my aim is to have it accurate enough to be used
            by educators.
          </p>
        </div>
      </section>
        ...
        <div className="hero-content w-full flex-col text-center">
          ...
          <div className="mt-6 grid w-full gap-3 sm:grid-cols-3">
            <Link
              ...
              className="btn card h-fit"
            >
              <div className="card-body items-center gap-2 p-5">
                <b className="font-semibold">
                  <IconFileDescription className="mr-2 inline size-5" />
                  Apply to collaborate
                </b>
                <p className="not-md:hidden text-base-content/60 text-sm">Submit your application</p>
              </div>
            </Link>
            <Link
              ...
              <div className="card-body items-center gap-2 p-5">
                <b className="font-semibold">
                  <svg
                    ...
                    className="mr-2 inline size-5 fill-current"
                    aria-hidden="true"
                  >
                ...
                <p className="not-md:hidden text-base-content/60 text-sm">Join the community</p>
              </div>
            </Link>
            <Link
            ...
            >
              <div className="card-body items-center gap-2 p-5">
                <div className="font-semibold">
                  <IconHash className="mr-2 inline size-5" />
                  Timeline channel
                </div>
                <p className="not-md:hidden text-base-content/60 text-sm">Follow project progress</p>
              </div>
            </Link>
          </div>
        </div>
      ...
      <section className="hero">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          />
          <p className="max-w-4xl rounded-lg bg-base-200 p-4">
            The diorama is 4,567 blocks long, starting with the formation of earth and ending at present time. The goal
            is to only use materials that would be present in that time, no green wool as grass etc. When there is a
            need for something not in vanilla, we make it and add it to the resource pack.
            <br />
            <br />
            The initial layout was built using simple noise patterns and this needs to be refined for the middle 3
      ...
      <section className="hero">
        <div className="hero-content flex-col lg:flex-row">
          ...
          />
          <p className="max-w-4xl rounded-lg bg-base-200 p-4">
            The most recent ~600 million years has plants and animals of the time, constrained to their duration on
            earth. For example T-rex was around from 69-66 mya so it's only in 4 blocks of the diorama. These custom
            resources need to be added into the world to create little scenes and fit with the topography.
            <br />
            <br />
            To give you an idea of scale, we have over 300 animals and 100 plants already created and are looking to
            include more.
          </p>
        </div>
      </section>
      <section className="hero">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          />
          <p className="max-w-4xl rounded-lg bg-base-200 p-4">
            The spawn location and hub of the timeline is a museum which will contain an interactive map, orientation
            and explanation of how and why we are doing things the way we are. Things like, if a tree's canopy is 5
            blocks wide, it doesn&rsquo;t mean the tree lived for 5 million years and other limitations that we have to
            concede to make the world work.
            <br />
            <br />
            In a future release the Museum will also have rooms for each time period. The final design for the interior
            and exterior of the museum needs to be decided on and built.
          </p>
        </div>
      </section>
      ...
      <section className="hero">
        <div className="hero-content flex-col lg:flex-row">
          ...
          <p className="max-w-4xl rounded-lg bg-base-200 p-4">
            ...
            besides using resources they have created for the mod, they have also created assets from other times for us
            to use.
            <br />
            <br />
      ...
      <section className="hero">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <p className="max-w-4xl rounded-lg bg-base-200 p-4">
            ...
            time period. This book will also basically act as a Pokedex. Plants and animals of each period will have
            grey silhouettes in the book and once they are found in the world, an entry unlocks and gives more
            information. An advancement is made once you find everything in a time period and I would like to add some
            more gameplay elements to help facilitate exploration.
          </p>
        </div>
      </section>
      <section className="hero">
      ...
      <div className="*:breadcrumbs flex flex-wrap justify-center gap-2 *:rounded-lg *:bg-base-200 *:p-4">
        <div>
          <ul>
            <li>
              <Link href="https://forms.gle/62mHkKNtHoZ3kqoS6" target="_blank">
        ...
        <div>
          <ul>
            <li>
              <Link href="https://discord.gg/gneiss-server-750062409364013159" target="_blank">
                <svg viewBox="0 0 256 199" preserveAspectRatio="xMidYMid" className="size-5 fill-current">
            ...
            <li>
              <Link href="https://discord.com/channels/750062409364013159/1293942024323596423" target="_blank">
